                ...
                <nav className="items-center justify-center ">
                    <div className="flex w-full bg-[#FA790F] items-center">
                        <UserDetails
                            ...
                            joinDate="Since April 2022"
                        />
                        <div>
                            <Link href={"/views/Homeowner/accountSettings"}>
                                <button
                                    type="button"
                                    className="text-[#FA790F] bg-white focus:ring-0 font-medium rounded leading-[130%] text-sm px-4 mr-20 py-2 mt-5 mb-2 "
                                >
                                    Account Settings
                                </button>
                            </Link>
                    ...
                    <div>
                        <Tabs>
                            <div className="flex cursor-pointer bg-[#FA790F]">
                                    ...
                                    <div className="flex gap-x-[8%] grow">
                                        <div className="grow w-[50%] pl-[5%]">
                                            <div className="flex gap-x-[35px] grow mb-0 mt-10">
                                                ...
                                                <div className="grow">
                                                    <ProfileRectangle profileViews="400" />
                                                </div>
                                            </div>
                                            <div className="flex grow mt-8 gap-x-[35px]">
                                                <div className="grow w-[10%]">
                                                    <BookingsRectangle totalBookings="17" />
                                                </div>
                                                <div className="grow w-[10%]">
                                                    <BookingsRectangle totalBookings="17" />
                                                </div>
                                                <div className="grow w-[10%]">
                                                    <PropertiesRectangle totalPropertySales="23" />
                                                </div>
                                            </div>
                                        </div>

                                        <div className="pr-[6%] w-[30%] grow mt-10">
                                            <LargeRectangle totalPropertySales="23" />
                                        </div>
                                    </div>

                                    <div className="ml-[5%] mt-7 shadow-lg mb-[5.125rem] w-[89%] h-[22rem] bg-white">
                                        <h6 className="text-[#FA790F] pl-16 pt-9 font-medium text-xl leading-8 ">
                                            Sales for the month
                                        </h6>
                            ...
                            <TabPanel>
                                <div className="relative overflow-x-auto bg-[#FAFAFA] sm:rounded-t-">
                                    <div className="flex">
                                        ...
                                        <Link
                                            href={
                                                "/views/forms/addPropertyForms"
                                            }
                                        >
                                            <button
                                                type="button"
                                                className="text-white leading-[125%] text-base bg-[#FA790F] focus:ring-0 font-medium rounded px-2 mr-20 py-2 mt-10  mb-2 "
                                            >
                                                + Add property
                                            </button>
                                        </Link>
                            ...
                            <TabPanel>
                                <div className="relative overflow-x-auto bg-[#FAFAFA]">
                                    <p className="mt-9 text-[#58575] font-normal leading-[140%] text-sm ml-20 ">
                                        Guests can only proceed to make payment
                                        after you have accepted their request
                                    </p>
                                                    ...
                                                    <tbody className="bg-white text-[#2E2D37]">
                                                        <tr className="border-b">
                                                            <AppointmentTable
                                                                ...
                                                                houseType="Mansion"
                                                                guestName="Hamida Mahama"
                                                                date="Starts 23/01/2023"
                                                                durationMonth="12 months"
                                                            />
                                                        </tr>
                                                        <tr className="border-b">
                                                            <AppointmentTable
                            ...
                            <TabPanel>
                                <div
                                    id="subscriptions"
                                    className="relative overflow-x-auto bg-[#FAFAFA] "
                                >
                                    <div className="ml-[5%] mt-10 flex">
                                        ...
                                        <div className="flex w-[566px] items-center h-[69px] bg-[#D1D2E4]/20 ">
                                            <Image
                                                ...
                                                alt={""}
                                            />
                                            <p className="text-[#58575F] font-medium text-sm leading-5 ml-3">
                                                Please note that you are
                                                currently on the free version.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <TabPanel>
                                <div className="relative overflow-x-auto bg-[#FAFAFA] ">
                                    <div className="bg-white mt-12 mr-20 ml-20 pb-20 ">
                                        <p className="text-[#FA790F] pt-[1.8125rem] mr-[2rem] cursor-pointer font-medium text-base leading-5 text-right">
                                            Mark all as read
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-[#FAFAFA] ">
                                        ...
                                        <div className="pt-20 pb-10 mb-[6.9375rem] bg-white mr-20 ml-20">
                                            <button
                                                type="button"
                                                className="ml-[50%] text-white font-medium leading-5 text-sm  bg-[#FA790F] focus:ring-0 rounded px-4  mr-20 py-2.5 mb-2 "
                                            >
                                                Load more
                                            </button>
                                        </div>
